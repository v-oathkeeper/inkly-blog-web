  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        text-gray-700"
        >
          Your story deserves a home. Start writing.
        </h1>
        ...
        text-gray-500"
        >
          This is your personal writing space — built for clarity, creativity,
          and control. Whether you're sharing ideas, journaling thoughts, or
        ...
        <form
          ...
          className="flex jsutify-between max-w-lg max-sm:scale-75 mx-auto
